...
export default function Swap({ type, from, to, onUserInput, typedValue, amount, trade, recipient }: SwapProps) {
  ...
  const [approval, approveCallback] = useApproveCallbackFromTrade(trade ?? undefined, allowedSlippage)
  ...
  return (
    <>
      ...
      />
      <CurrencyInput
        style={{background: '#2F303E', color:'#4A4A68', height:'38px'}}
      ...
      <CurrencyInput 
        ...
        color={{label:'#9c9cb2', unit:'#9c9cb2'}}
     />
      {!account ? (
