...
import { isAddress, getHpbscanLink } from '../../utils'
...
export default function VotePage({
  ...
  const linkIfAddress = (content: string) => {
    if (isAddress(content) && chainId) {
      return <ExternalLink href={getHpbscanLink(content, 'address')}>{content}</ExternalLink>
    }
    ...
    <PageWrapper gap="lg" justify="center">
      ...
      <ProposalInfo gap="lg" justify="start">
        ...
        <AutoColumn gap="md">
          ...
          <ExternalLink
            href={proposalData?.proposer && chainId ? getHpbscanLink(proposalData?.proposer, 'address') : ''}
          >
