...
import { getHpbscanLink, shortenAddress } from '../../utils'
    ...
    <Wrapper error={duplicateNameOrSymbol}>
      <AutoRow gap="6px">
        ...
        <AutoColumn gap="10px" justify="flex-start">
          ...
          {chainId && (
            <ExternalLink style={{ fontWeight: 400 }} href={getHpbscanLink(token.address, 'token')}>
              <TYPE.blue title={token.address}>{shortenAddress(token.address)} (View on hpbscan)</TYPE.blue>
            </ExternalLink>
          )}
        </AutoColumn>
      </AutoRow>
