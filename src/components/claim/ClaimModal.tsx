...
import { useActiveWeb3React, useActiveHPBWeb3React } from '../../hooks'
        ...
        <ConfirmOrLoadingWrapper activeBG={true}>
          ...
          <AutoColumn gap="100px" justify={'center'}>
            ...
            {attempting && claimSubmitted && !claimConfirmed && chainId && claimTxn?.hash && (
              <ExternalLink href={getHpbscanLink(claimTxn?.hash, 'transaction')} style={{ zIndex: 99 }}>
                View transaction on hpbscan
              </ExternalLink>
            )}
          </AutoColumn>
